<a href="/">
    ...
    <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 534 534" width="4rem" height="4rem">
        <style>
            .st0 {
                fill: #f8f8f8
            }
        ...
        <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="210.818" y1="264.548" x2="257.034"
            y2="45.227">
        ...
        <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="260.056" y1="277.6" x2="242.121"
            y2="69.177">
            <stop offset=".064" stop-color="#512589" />
            <stop offset=".435" stop-color="#8b307d" />
            <stop offset=".708" stop-color="#cb3c6f" />
        ...
        <linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="137.939" y1="326.051" x2="209.676"
            y2="137.371">
            <stop offset=".064" stop-color="#512589" />
            <stop offset=".435" stop-color="#8b307d" />
            <stop offset=".708" stop-color="#cb3c6f" />
        ...
        <linearGradient id="SVGID_4_" gradientUnits="userSpaceOnUse" x1="330.171" y1="312.71" x2="307.376"
            y2="184.251">
            <stop offset=".064" stop-color="#512589" />
            <stop offset=".435" stop-color="#8b307d" />
            <stop offset=".708" stop-color="#cb3c6f" />
        ...
        <linearGradient id="SVGID_5_" gradientUnits="userSpaceOnUse" x1="397.875" y1="343.556" x2="346.676"
            y2="203.992">
            <stop offset=".064" stop-color="#512589" />
            <stop offset=".435" stop-color="#8b307d" />
            <stop offset=".708" stop-color="#cb3c6f" />
